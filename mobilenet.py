...
class MobileNet(object):
    ...
    def build_model(self):
        with tf.variable_scope(self.scope):
            net = conv2d(self.inputs,"conv_1",round(32*width_multipliter),
            ...
            = self._depthwise_separable_conv2d(net, 128, self.width_multiplier,
                                               "ds_conv_3")  # ->[N, 112, 112, 64]

    def _depthwise_separable_conv2d(self,inputs,num_filters,width_multipliter,scope,dwonsample=False):
