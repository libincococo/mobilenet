...
parser.add_argument('--dataset_dir', type=str, default='./cifar10', help='tfrecord file dir')
parser.add_argument('--num_samples', type=int, help='the number of train samples',default=500000)
parser.add_argument('--epoch', type=int, default=10)
parser.add_argument('--batch_size', type=int, default=16)
parser.add_argument('--num_classes', type=int,default=10)
parser.add_argument('--num_log', type=int,default=100)
...
parser.add_argument('--lr_decay_step', dest='lr_decay_step',default=1000)
# set default
